    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-3">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Quantidade máxima de fotos *</label>
            <input
              type="number"
              min="1"
              className="input-field"
            ...
            <p className="text-xs text-gray-400 mt-1">
              A 1ª foto desse item é sempre obrigatória. Fotos extras, até esse número, são opcionais.
            </p>
          </div>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-medium text-gray-600 w-24">Máx. fotos</th>
